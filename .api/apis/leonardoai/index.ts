...
class SDK {
  ...
  constructor() {
    ...
    this.core = new APICore(this.spec, 'leonardoai/v1.0.0 (api/6.1.2)');
  }
  ...
  getTextureGenerationsByModelId(body?: types.GetTextureGenerationsByModelIdBodyParam | types.GetTextureGenerationsByModelIdMetadataParam, metadata?: types.GetTextureGenerationsByModelIdMetadataParam): Promise<FetchResponse<200, types.GetTextureGenerationsByModelIdResponse200>> {
  ...
  getTextureGenerationById(body?: types.GetTextureGenerationByIdBodyParam | types.GetTextureGenerationByIdMetadataParam, metadata?: types.GetTextureGenerationByIdMetadataParam): Promise<FetchResponse<200, types.GetTextureGenerationByIdResponse200>> {
  ...
  deleteTextureGenerationById(body?: types.DeleteTextureGenerationByIdBodyParam | types.DeleteTextureGenerationByIdMetadataParam, metadata?: types.DeleteTextureGenerationByIdMetadataParam): Promise<FetchResponse<200, types.DeleteTextureGenerationByIdResponse200>> {
  ...
  get3DModelsByUserId(body?: types.Get3DModelsByUserIdBodyParam | types.Get3DModelsByUserIdMetadataParam, metadata?: types.Get3DModelsByUserIdMetadataParam): Promise<FetchResponse<200, types.Get3DModelsByUserIdResponse200>> {
  ...
  get3DModelById(body?: types.Get3DModelByIdBodyParam | types.Get3DModelByIdMetadataParam, metadata?: types.Get3DModelByIdMetadataParam): Promise<FetchResponse<200, types.Get3DModelByIdResponse200>> {
  ...
  delete3DModelById(body?: types.Delete3DModelByIdBodyParam | types.Delete3DModelByIdMetadataParam, metadata?: types.Delete3DModelByIdMetadataParam): Promise<FetchResponse<200, types.Delete3DModelByIdResponse200>> {
   ...
   */
  getCustomModelsByUserId(metadata: types.GetCustomModelsByUserIdMetadataParam): Promise<FetchResponse<200, types.GetCustomModelsByUserIdResponse200>> {
   ...
   */
  getElementById(metadata: types.GetElementByIdMetadataParam): Promise<FetchResponse<200, types.GetElementByIdResponse200>> {
   ...
   */
  deleteElementById(metadata: types.DeleteElementByIdMetadataParam): Promise<FetchResponse<200, types.DeleteElementByIdResponse200>> {
   ...
   */
  getCustomElementsByUserId(metadata: types.GetCustomElementsByUserIdMetadataParam): Promise<FetchResponse<200, types.GetCustomElementsByUserIdResponse200>> {
   ...
   */
  createElement(body: types.CreateElementBodyParam): Promise<FetchResponse<200, types.CreateElementResponse200>> {
...
export type { CreateDatasetBodyParam, CreateDatasetResponse200, CreateElementBodyParam, CreateElementResponse200, CreateGenerationBodyParam, CreateGenerationResponse200, CreateLcmGenerationBodyParam, CreateLcmGenerationResponse200, CreateModelBodyParam, CreateModelResponse200, CreateSvdMotionGenerationBodyParam, CreateSvdMotionGenerationResponse200, CreateTextureGenerationBodyParam, CreateTextureGenerationResponse200, CreateUniversalUpscalerJobBodyParam, CreateUniversalUpscalerJobResponse200, CreateVariationNoBgBodyParam, CreateVariationNoBgResponse200, CreateVariationUnzoomBodyParam, CreateVariationUnzoomResponse200, CreateVariationUpscaleBodyParam, CreateVariationUpscaleResponse200, Delete3DModelByIdBodyParam, Delete3DModelByIdMetadataParam, Delete3DModelByIdResponse200, DeleteDatasetByIdMetadataParam, DeleteDatasetByIdResponse200, DeleteElementByIdMetadataParam, DeleteElementByIdResponse200, DeleteGenerationByIdMetadataParam, DeleteGenerationByIdResponse200, DeleteInitImageByIdMetadataParam, DeleteInitImageByIdResponse200, DeleteModelByIdMetadataParam, DeleteModelByIdResponse200, DeleteTextureGenerationByIdBodyParam, DeleteTextureGenerationByIdMetadataParam, DeleteTextureGenerationByIdResponse200, Get3DModelByIdBodyParam, Get3DModelByIdMetadataParam, Get3DModelByIdResponse200, Get3DModelsByUserIdBodyParam, Get3DModelsByUserIdMetadataParam, Get3DModelsByUserIdResponse200, GetCustomElementsByUserIdMetadataParam, GetCustomElementsByUserIdResponse200, GetCustomModelsByUserIdMetadataParam, GetCustomModelsByUserIdResponse200, GetDatasetByIdMetadataParam, GetDatasetByIdResponse200, GetElementByIdMetadataParam, GetElementByIdResponse200, GetGenerationByIdMetadataParam, GetGenerationByIdResponse200, GetGenerationsByUserIdMetadataParam, GetGenerationsByUserIdResponse200, GetInitImageByIdMetadataParam, GetInitImageByIdResponse200, GetModelByIdMetadataParam, GetModelByIdResponse200, GetTextureGenerationByIdBodyParam, GetTextureGenerationByIdMetadataParam, GetTextureGenerationByIdResponse200, GetTextureGenerationsByModelIdBodyParam, GetTextureGenerationsByModelIdMetadataParam, GetTextureGenerationsByModelIdResponse200, GetUserSelfResponse200, GetVariationByIdMetadataParam, GetVariationByIdResponse200, ListElementsResponse200, ListPlatformModelsResponse200, PerformAlchemyUpscaleLcmBodyParam, PerformAlchemyUpscaleLcmResponse200, PerformInpaintingLcmBodyParam, PerformInpaintingLcmResponse200, PerformInstantRefineBodyParam, PerformInstantRefineResponse200, PricingCalculatorBodyParam, PricingCalculatorResponse200, PromptImproveBodyParam, PromptImproveResponse200, PromptRandomResponse200, UploadCanvasInitImageBodyParam, UploadCanvasInitImageResponse200, UploadDatasetImageBodyParam, UploadDatasetImageFromGenBodyParam, UploadDatasetImageFromGenMetadataParam, UploadDatasetImageFromGenResponse200, UploadDatasetImageMetadataParam, UploadDatasetImageResponse200, UploadInitImageBodyParam, UploadInitImageResponse200, UploadModelAssetBodyParam, UploadModelAssetResponse200 } from './types';
